...
The following example Jupyter Notebooks contain use cases for this Text-Fabric dataset. The Notebooks are grouped, somewhat arbitrarily, based on focus areas.
